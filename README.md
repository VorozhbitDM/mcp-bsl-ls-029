...
- **[BSL Language Server 0.29.0](https://github.com/1c-syntax/bsl-language-server/releases)** — JAR-файл (`bsl-language-server-0.29.0-exec.jar`), документация: [1c-syntax.github.io/bsl-language-server](https://1c-syntax.github.io/bsl-language-server/)
...
- [BSL Language Server — релизы (GitHub)](https://github.com/1c-syntax/bsl-language-server/releases)
