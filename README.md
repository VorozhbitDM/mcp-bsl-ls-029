...
Конфиг адаптирован для Cursor, чтобы заработало в kiro нужно переименовать файл configForKiro в config по пути
D:\путь\к\проекту\mcp-bsl-ls-029\src\mcp_bsl
Также в этом конфиге прописаны пути до папки с mcp-сервером, отредактируйте и укажите свои.
